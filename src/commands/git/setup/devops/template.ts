...
export default class Release extends Command {
  static description = 'Add all required files and folders for Azure DevOps CI/CD setup. Instantly create templates, pipelines, and configuration files for best practices and automation.';
