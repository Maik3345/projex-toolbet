...
} from '../../../../../../src/modules/apps/pull-request/labels/suggest/analyzers';
import { AnalysisContext } from '../../../../../../src/modules/apps/pull-request/labels/suggest/types';
  ...
  commits: [
    {
      ...
      fullMessage: 'feat: add new button component\n\nAdded a reusable button component for the UI',
    },
    {
      id: 'def456',
      message: 'fix: resolve helper bug',
      fullMessage: 'fix: resolve helper bug\n\nFixed critical bug in helper function',
    },
  ],
...
describe('determineReleaseLabels', () => {
  ...
  it('should detect minor release for new features', () => {
    const context = createMockContext({
      ...
      commits: [{ id: 'abc', message: 'feat: add new feature', fullMessage: 'feat: add new feature' }],
    });
  ...
  it('should detect patch release for bug fixes', () => {
    const context = createMockContext({
      ...
      commits: [{ id: 'abc', message: 'fix: resolve critical bug', fullMessage: 'fix: resolve critical bug' }],
    });
