...
import Browse from '../../../src/commands/bash/run';
import { bashRunCommand } from '../../../src/modules/apps/bash/run';

vi.mock('../../../src/modules/apps/bash/run', () => ({
...
// test moved from src/commands/bash/run.test.ts
